...
public class SubscriberController {
  ...
  public Mono<Void> handleMessageTyped(@RequestBody(required = false) CloudEvent<DaprPubSubIT.MyObject> envelope) {
    return Mono.fromRunnable(() -> {
      try {
  ...
  public Mono<Void> handleMessageLongValues(@RequestBody(required = false) CloudEvent<DaprPubSubIT.ConvertToLong> cloudEvent) {
    return Mono.fromRunnable(() -> {
      try {
